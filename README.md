...
- [data-validator](#data-validator)
  ...
  - [7. Understanding the output](#7-understanding-the-output)
    ...
    - [The output table format](#the-output-table-format)
  - [8. Reports explained](#8-reports-explained)
  - [9. Custom cross-tabulations](#9-custom-cross-tabulations)
    - [Defining tabulations in Python](#defining-tabulations-in-python)
    - [Defining tabulations in a YAML file](#defining-tabulations-in-a-yaml-file)
    - [Defining tabulations in a JSON file](#defining-tabulations-in-a-json-file)
    - [StatSpec expression reference](#statspec-expression-reference)
  ...
  - [11. Using in JupyterHub or Microsoft Fabric](#11-using-in-jupyterhub-or-microsoft-fabric)
    - [Memory management on Kubernetes / Fabric](#memory-management-on-kubernetes--fabric)
